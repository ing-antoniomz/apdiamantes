...
<div class="mb-18">
    ...
    <div class="mb-10">
        ...
        <div class="overlay">
            <!--begin::Image-->
            <img class="w-100 card-rounded" src="{{ asset(theme()->getMediaUrlPath() . 'stock/1600x800/img-1.jpg') }}" alt="">
            <!--end::Image-->

            <!--begin::Links-->
            {{-- <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                <a href="/metronic8/demo3/pages/pricing.html" class="btn btn-light-primary">Pricing</a>

                <a href="/metronic8/demo3/pages/careers/apply.html" class="btn btn-light-primary ms-3">Join Us</a>
            </div> --}}
            <!--end::Links-->
        </div>
        <!--end::Container-->
    ...
    <div class="fs-5 fw-semibold text-gray-600">
        ...
        <p class="mb-8">
            ...
            From the seed of the idea to finally hitting “Publish,” you might spend several days or maybe even a week
            “writing” a blog post, but it’s important to spend those vital hours planning
            your post and even thinking about

            <a href="/metronic8/demo3/pages/blog/post.html" class="link-primary pe-1">Your Post</a>
        ...
        <p class="mb-8">
            ...
            <a href="/metronic8/demo3/pages/blog/home.html" class="link-primary pe-1">I mean NOTHING</a>
        ...
        <!--begin::Text-->
        <p class="mb-17">
            I can hear your objections already. “But Dan, I have to blog for a cardboard box manufacturing company.” I
            ...
            compliance and corporate housing), but the hallmark of a professional blogger is the ability to write well
            about any topic, no matter how dry it may be.
...
<div class="card bg-light mb-18">
    ...
    <div class="card-body py-15">
        ...
        <div class="fs-2 fw-semibold text-muted text-center">
            <a href="/metronic8/demo3/account/security.html" class="link-primary fs-4 fw-bold">Marcus Levy</a>
    ...
    <div class="row g-10">
        ...
        <div class="col-md-4">
            ...
            <div class="card-xl-stretch me-md-6">
                ...
                <a class="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales"
                    href="/metronic8/demo3/assets/media/stock/600x400/img-73.jpg">
                    <!--begin::Image-->
                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                        style="background-image:url('{{ theme()->getMediaUrlPath('stock/600x400/img-73.jpg') }}')">
                    </div>
                    <!--end::Image-->
                ...
                <div class="m-0">
                    <!--begin::Title-->
                    <a href="/metronic8/demo3/pages/user-profile/overview.html"
                    ...
                    <div class="fs-6 fw-bold">
                        <!--begin::Author-->
                        <a href="/metronic8/demo3/apps/projects/users.html"
        ...
        <div class="col-md-4">
            ...
            <div class="card-xl-stretch mx-md-3">
                <!--begin::Overlay-->
                <a class="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales"
                    href="/metronic8/demo3/assets/media/stock/600x400/img-74.jpg">
                    <!--begin::Image-->
                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                        style="background-image:url('{{ theme()->getMediaUrlPath('stock/600x400/img-74.jpg') }}')">
                    </div>
                    <!--end::Image-->
        ...
        <div class="col-md-4">
            ...
            <div class="card-xl-stretch ms-md-6">
                <!--begin::Overlay-->
                <a class="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales"
                    href="/metronic8/demo3/assets/media/stock/600x400/img-47.jpg">
                    <!--begin::Image-->
                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                        style="background-image:url('{{ theme()->getMediaUrlPath('stock/600x400/img-47.jpg') }}')">
                    </div>
                    <!--end::Image-->
    ...
    <div class="tns tns-default mb-10 tns-initiazlied">
        ...
        <div class="tns-outer" id="tns1-ow">
            <div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span
                    class="current">8 to 10</span> of 7</div>
            <div id="tns1-mw" class="tns-ovh">
                <div class="tns-inner" id="tns1-iw">
                    <div
                        data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000"
                        data-tns-autoplay="false" data-tns-controls="true" data-tns-nav="false" data-tns-items="3"
                        ...
                        style="transform: translate3d(-46.6667%, 0px, 0px);"{{--  data-kt-initialized="1" --}}>
                        <!--begin::Item-->
                        <div class="text-center tns-item tns-slide-active" id="tns1-item0">
                            <!--begin::Photo-->
                            <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                style="background-image:url('{{ theme()->getMediaUrlPath('avatars/300-1.jpg') }}')">
                            </div>
                            <!--end::Photo-->
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <div class="text-center tns-item tns-slide-active" id="tns1-item1">
                            <!--begin::Photo-->
                            <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                style="background-image:url('{{ theme()->getMediaUrlPath('avatars/300-2.jpg') }}')">
                            </div>
                            <!--end::Photo-->
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <div class="text-center tns-item tns-slide-active" id="tns1-item2">
                            <!--begin::Photo-->
                            <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                style="background-image:url('{{ theme()->getMediaUrlPath('avatars/300-5.jpg') }}')">
                            </div>
                            <!--end::Photo-->
                        ...
                        <div class="text-center tns-item" id="tns1-item3" aria-hidden="true" tabindex="-1">
                            <!--begin::Photo-->
                            <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                style="background-image:url('{{ theme()->getMediaUrlPath('avatars/300-20.jpg') }}')">
                            </div>
                            <!--end::Photo-->
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <div class="text-center tns-item" id="tns1-item4" aria-hidden="true" tabindex="-1">
                            <!--begin::Photo-->
                            <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                style="background-image:url('{{ theme()->getMediaUrlPath('avatars/300-23.jpg') }}')">
                            </div>
                            <!--end::Photo-->
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <div class="text-center tns-item" id="tns1-item5" aria-hidden="true" tabindex="-1">
                            <!--begin::Photo-->
                            <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                style="background-image:url('{{ theme()->getMediaUrlPath('avatars/300-12.jpg') }}')">
                            </div>
                            <!--end::Photo-->
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <div class="text-center tns-item" id="tns1-item6" aria-hidden="true" tabindex="-1">
                            <!--begin::Photo-->
                            <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                style="background-image:url('{{ theme()->getMediaUrlPath('avatars/300-9.jpg') }}')">
                            </div>
                            <!--end::Photo-->
        ...
        <button class="btn btn-icon btn-active-color-primary" id="kt_team_slider_prev" aria-controls="tns1" tabindex="-1" data-controls="prev">
            ...
            <img src="{{ asset(theme()->getMediaUrlPath() . 'icons/duotune/arrows/arr074.svg') }}" alt="Icono" width="24" height="24">
        </button>
        <!--end::Button-->
        ...
        <button class="btn btn-icon btn-active-color-primary" id="kt_team_slider_next" aria-controls="tns1"
            ...
            <img src="{{ asset(theme()->getMediaUrlPath() . 'icons/duotune/arrows/arr071.svg') }}" alt="Icono" width="24"
                height="24">
        <!--end::Button-->
    </div>
    <!--end::Slider-->
