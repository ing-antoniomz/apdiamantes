    ...
    <div class="row">
            ...
            <div class="h-100 d-flex flex-column justify-content-between pe-lg-6 mb-lg-0 mb-10">
                ...
                <div class="mb-3">
                    <iframe class="embed-responsive-item card-rounded h-275px w-100"
                        src="https://www.youtube.com/embed/TWdDZYNqlg4" allowfullscreen=""></iframe>
                </div>
                <!--end::Video-->
                ...
                <div class="mb-5">
                    <!--begin::Title-->
                    <a href="{{ url('blog/prueba') }}" class="fs-2 text-gray-900 fw-bold text-hover-primary text-gray-900 lh-base">
                ...
                <div class="d-flex flex-stack flex-wrap">
                    ...
                    <div class="d-flex align-items-center pe-2">
                        ...
                        <div class="symbol symbol-35px symbol-circle me-3">
                            <img alt="" src="{{ asset(theme()->getMediaUrlPath() . 'avatars/300-9.jpg') }}">
                        </div>
                        <!--end::Avatar-->
        ...
        <div class="col-md-6 justify-content-between d-flex flex-column">
            ...
            <div class="ps-lg-6 mb-16 mt-md-0 mt-17">
                ...
                <div class="mb-6">
                    <!--begin::Title-->
                    <a href="#" class="fw-bold text-gray-900 mb-4 fs-2 lh-base text-hover-primary">
            ...
            <div class="ps-lg-6 mb-16">
                ...
                <div class="d-flex flex-stack flex-wrap">
                    ...
                    <div class="d-flex align-items-center pe-2">
                        <!--begin::Avatar-->
                        <div class="symbol symbol-35px symbol-circle me-3">
                            <img src="{{ asset(theme()->getMediaUrlPath() . 'avatars/300-16.jpg') }}" class="" alt="">
                        </div>
                        <!--end::Avatar-->
            ...
            <div class="ps-lg-6 ">
                ...
                <div class="d-flex flex-stack flex-wrap">
                    ...
                    <div class="d-flex align-items-center pe-2">
                        <!--begin::Avatar-->
                        <div class="symbol symbol-35px symbol-circle me-3">
                            <img src="{{ asset(theme()->getMediaUrlPath() . 'avatars/300-19.jpg') }}" class="" alt="">
                        </div>
                        <!--end::Avatar-->
    ...
    <div class="row g-10">
        ...
        <div class="col-md-4">
            ...
            <div class="card-xl-stretch me-md-6">
                ...
                <a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5"
                    style="background-image:url('{{ asset(theme()->getMediaUrlPath() . 'stock/600x400/img-73.jpg') }}')"
                    data-fslightbox="lightbox-video-tutorials" href="https://www.youtube.com/embed/btornGtLwIo">

                    <img src="{{ asset(theme()->getMediaUrlPath() . 'svg/misc/video-play.svg') }}"{{ asset(theme()->getMediaUrlPath() . 'svg/misc/video-play.svg') }}
        ...
        <div class="col-md-4">
            ...
            <div class="card-xl-stretch mx-md-3">
                <!--begin::Image-->
                <a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5"
                    style="background-image:url('{{ asset(theme()->getMediaUrlPath() . 'stock/600x400/img-79.jpg') }}')"
                    data-fslightbox="lightbox-video-tutorials" href="https://www.youtube.com/embed/btornGtLwIo">

                    <img src="{{ asset(theme()->getMediaUrlPath() . 'svg/misc/video-play.svg') }}"
                        class="position-absolute top-50 start-50 translate-middle" alt="">
                </a>
                <!--end::Image-->
        ...
        <div class="col-md-4">
            ...
            <div class="card-xl-stretch ms-md-6">
                <!--begin::Image-->
                <a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5"
                    style="background-image:url('{{ asset(theme()->getMediaUrlPath() . 'stock/600x400/img-47.jpg') }}')"
    ...
    <div class="row g-10">
        ...
        <div class="col-md-4">
            ...
            <div class="card-xl-stretch me-md-6">
                ...
                <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                    href="/metronic8/demo3/assets/media/stock/600x400/img-23.jpg">
                    <!--begin::Image-->
                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                        style="background-image:url('{{ asset(theme()->getMediaUrlPath() . 'stock/600x400/img-23.jpg') }}')">
                    </div>
                    <!--end::Image-->

                    <!--begin::Action-->
                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                        <i class="ki-duotone ki-eye fs-2x text-white"><span class="path1"></span><span
                ...
                <div class="mt-5">
                    <!--begin::Title-->
                    <a href="#" class="fs-4 text-gray-900 fw-bold text-hover-primary text-gray-900 lh-base">
        ...
        <div class="col-md-4">
            ...
            <div class="card-xl-stretch mx-md-3">
                <!--begin::Overlay-->
                <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                    href="/metronic8/demo3/assets/media/stock/600x600/img-14.jpg">
                    <!--begin::Image-->
                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                        style="background-image:url('{{ asset(theme()->getMediaUrlPath() . 'stock/600x400/img-14.jpg') }}')">
                    </div>
                    <!--end::Image-->
        ...
        <div class="col-md-4">
            ...
            <div class="card-xl-stretch ms-md-6">
                <!--begin::Overlay-->
                <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                    href="/metronic8/demo3/assets/media/stock/600x400/img-71.jpg">
                    <!--begin::Image-->
                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                        style="background-image:url('{{ asset(theme()->getMediaUrlPath() . 'stock/600x400/img-71.jpg') }}')">
                    </div>
                    <!--end::Image-->
...
<div class="">
    ...
    <div class="row g-10 row-cols-2 row-cols-lg-5">
        ...
        <div class="col">
            <!--begin::Overlay-->
            <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                href="/metronic8/demo3/assets/media/stock/900x600/16.jpg">
                <!--begin::Image-->
                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                    style="background-image:url('{{ asset(theme()->getMediaUrlPath() . 'stock/900x600/16.jpg') }}')">
                </div>
                <!--end::Image-->
        ...
        <div class="col">
            <!--begin::Overlay-->
            <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                href="/metronic8/demo3/assets/media/stock/900x600/13.jpg">
                <!--begin::Image-->
                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                    style="background-image:url('{{ asset(theme()->getMediaUrlPath() . 'stock/900x600/13.jpg') }}')">
                </div>
                <!--end::Image-->
        ...
        <div class="col">
            <!--begin::Overlay-->
            <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                href="/metronic8/demo3/assets/media/stock/900x600/19.jpg">
                <!--begin::Image-->
                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                    style="background-image:url('{{ asset(theme()->getMediaUrlPath() . 'stock/900x600/19.jpg') }}')">
                </div>
                <!--end::Image-->
        ...
        <div class="col">
            <!--begin::Overlay-->
            <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                href="/metronic8/demo3/assets/media/stock/900x600/15.jpg">
                <!--begin::Image-->
                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                    style="background-image:url('{{ asset(theme()->getMediaUrlPath() . 'stock/900x600/15.jpg') }}')">
                </div>
                <!--end::Image-->
        ...
        <div class="col">
            <!--begin::Overlay-->
            <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                href="/metronic8/demo3/assets/media/stock/900x600/12.jpg">
                <!--begin::Image-->
                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                    style="background-image:url('{{ asset(theme()->getMediaUrlPath() . 'stock/900x600/12.jpg') }}')">
                </div>
                <!--end::Image-->
