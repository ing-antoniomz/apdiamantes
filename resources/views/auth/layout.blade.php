...
@section('content')
            ...
            <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
                ...
                <div class="d-flex flex-center flex-wrap px-5">
                    ...
                    <div class="d-flex fw-semibold text-primary fs-base">
                        ...
                        <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_contacto" class="px-5 text-white user-select-none">{{ __('Contact Us') }}</a>
    ...
    <div class="modal fade" tabindex="-1" id="kt_modal_contacto">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                {{-- <div class="modal-header">
                    <h3 class="modal-title">{{ __('About') }}</h3>
                ...
                <div class="modal-body mx-5">
                    ...
                    @include('pages.contact._contact')
                </div>
